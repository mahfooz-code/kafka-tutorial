package com.mahfooz.spark.consumer;
...
import com.mahfooz.spark.consumer.model.CountryPopulation;
...
class CountryPopulationConsumerTest {
    ...
    void whenStartingBySubscribingToTopicAndExceptionOccurs_thenExpectExceptionIsHandledCorrectly() {
        // GIVEN
        consumer.schedulePollTask(() -> consumer.setException(new KafkaException("poll exception")));
        consumer.schedulePollTask(() -> countryPopulationConsumer.stop());
