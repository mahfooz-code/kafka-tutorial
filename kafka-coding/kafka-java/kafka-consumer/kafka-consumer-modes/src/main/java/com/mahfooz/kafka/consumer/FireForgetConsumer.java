...
public class FireForgetConsumer {

    public static void main(String[] args) {

        Properties properties= ConsumerConfigUtil.getConsumerProps("fire.forget");
        String topicName="fire.forget";
        properties.put(ConsumerConfig.REQUEST_TIMEOUT_MS_CONFIG, "50000");
        properties.put(ConsumerConfig.CLIENT_ID_CONFIG, "consumer.fire.forget");
