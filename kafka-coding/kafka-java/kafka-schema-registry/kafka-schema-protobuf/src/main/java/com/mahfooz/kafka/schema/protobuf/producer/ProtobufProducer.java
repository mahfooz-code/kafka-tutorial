package com.mahfooz.kafka.schema.protobuf.producer;

import com.mahfooz.kafka.protobuf.SimpleMessageProtos.*;
...
public class ProtobufProducer {
    ...
    public void writeMessage() {
        ...
        properties.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "mtmdevhdoped01:19092");
        properties.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
        properties.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, KafkaProtobufSerializer.class);
        properties.put(KafkaProtobufSerializerConfig.SCHEMA_REGISTRY_URL_CONFIG, "http://mtmdevhdoped01:8081");
