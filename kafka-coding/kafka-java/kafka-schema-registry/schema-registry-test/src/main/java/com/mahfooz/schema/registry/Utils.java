...
public class Utils {
    ...
    public static final String TEST_TOPIC_AVRO = "avro-topic";
    public static final String TEST_TOPIC_PROTO = "proto-topic";
    public static final String TEST_TOPIC_JSON = "json-topic";
    ...
    private static String getSchemaRegistryUrl(){
        ...
        return Objects.requireNonNullElse(fromEnv, "http://mtmdevhdoped01:8081");
    }

    private static String getBootstrapServers(){
        String fromEnv = System.getenv("BOOTSTRAP_SERVERS");
        return Objects.requireNonNullElse(fromEnv, "mtmdevhdoped01:19092");
    }
